        ...
        return function () {
            ...
            return {
                errorLoading: function () {
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.errorLoading) !== 'undefined')
                    {
                        return stgh_select2_l10n.errorLoading;
                    }else
                    {
                        return "The results could not be loaded."
                    }
                }, inputTooLong: function (a) {
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.inputTooLong_n) !== 'undefined' && typeof(stgh_select2_l10n.inputTooLong_nplus) !== 'undefined')
                    {
                        var b = a.input.length - a.maximum, c = stgh_select2_l10n.inputTooLong_n+" " + b + " "+stgh_select2_l10n.inputTooLong_nplus;
                    }else
                    {
                    ...
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.inputTooShort_n) !== 'undefined' && typeof(stgh_select2_l10n.inputTooShort_nplus) !== 'undefined')
                    {
                        var b = a.minimum - a.input.length, c = stgh_select2_l10n.inputTooShort_n+" " + b + " "+stgh_select2_l10n.inputTooShort_nplus;
                    }else
                    {
                    ...
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.loadingMore) !== 'undefined')
                    {
                        return stgh_select2_l10n.loadingMore
                    }else
                    {
                        return "Loading more results…"
                    }
                }, maximumSelected: function (a) {
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.maximumSelected_n) !== 'undefined'&& typeof(stgh_select2_l10n.maximumSelected_nplus) !== 'undefined')
                    {
                        var b = stgh_select2_l10n.maximumSelected_n+" " + a.maximum + " "+stgh_select2_l10n.maximumSelected_nplus;
                    ...
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.noResults) !== 'undefined')
                    {
                        return stgh_select2_l10n.noResults
                    }else
                    {
                        return "No results found"
                    }
                }, searching: function () {
                    if(typeof(stgh_select2_l10n) !== 'undefined' && typeof(stgh_select2_l10n.searching) !== 'undefined')
                    {
                        return stgh_select2_l10n.searching
                    }else
                    {
                        return "Searching…"
                    }
            ...
            return null == a.fn.stgselect2.defaults && (a.fn.stgselect2.defaults = d), c
        }), b.define("jquery.mousewheel", ["jquery"], function (a) {
            return a
        }), {define: b.define, require: b.require}
    }(), c = b.require("jquery.select2");
    return a.fn.stgselect2.amd = b, c
});