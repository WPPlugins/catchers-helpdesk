...
<div class="stgh-metabox submitbox">
    ...
    <div class="stgh-metabox-inner-item stgh-metabox-details-item">
        <label for="post-date">
            ...
            <span id="stgh-metabox-details-date-selected">
                <span class="stgh-ticket-details-item-selected"><?= get_the_date() . ' ' . get_the_time(); ?></span>
                <a class="stgh-metabox-details-click"
                   data-block="stgh-metabox-details-date"><?= __('Change', STG_HELPDESK_TEXT_DOMAIN_NAME) ?></a>
            </span>
            <span id="stgh-metabox-details-date-select" class="stgh_display_none">
                <?= touch_time(1,1,0,1) ?>
            </span>
        </label>
    </div>
